...
while True:
    ...
    print("1. NRZ-L Encoder dan Decoder") # Pilihan untuk NRZ-L Encoder dan Decoder
    print("2. Manchester Encoder dan Decoder")   # Pilihan untuk Manchester Encoder dan Decoder
    ...
    if pilihan == "1": # Jika pilihan adalah 1
        print("=== NRZ-L Encoder dan Decoder ===") # Menampilkan judul NRZ-L Encoder dan Decoder
        ...
        print("=== Manchester Encoder dan Decoder ===") # Menampilkan judul Manchester Encoder dan Decoder
